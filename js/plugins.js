...
$({numberValue: currentNumber}).animate({numberValue: 92.5}, {
duration: 2500,
easing: 'linear',
step: function (now) {
...
$({numberValue: currentNumber}).animate({numberValue: 79.8}, {
duration: 2500,
easing: 'linear',
step: function (now) {
...
$({numberValue: currentNumber}).animate({numberValue:95.60}, {
duration: 2500,
easing: 'linear',
step: function (now) {
